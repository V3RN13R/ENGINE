...
cd ..
set dependenciesDir=%CD%
echo dependenciesDir== %dependenciesDir%
cd ..\Exes
set dllsMoveTo=%CD%
echo dllsMoveTo== %dllsMoveTo%


cd %CEGUIDir%\ceguiDependencies
echo actualDir= %CD%
mkdir .\build\x64
cd .\build\x64
