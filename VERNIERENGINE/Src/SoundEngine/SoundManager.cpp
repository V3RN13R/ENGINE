...
void SoundManager::playSound(const char* filename, int volume)
{
	playAudio(filename, NULL, 0, volume);
}

void SoundManager::playMusic(const char* filename, int volume)
{
	playAudio(filename, NULL, 1, volume);
}

void SoundManager::playSoundFromMemory(Audio* audio, int volume)
{
	playAudio(NULL, audio, 0, volume);
}

void SoundManager::playMusicFromMemory(Audio* audio, int volume)
{
...
void SoundManager::endAudio(void)
{
...
void SoundManager::pauseAudio(void)
{
	if (gDevice->audioEnabled)
	{
...
void SoundManager::unpauseAudio(void)
{
	if (gDevice->audioEnabled)
	{
...
void SoundManager::freeAudio(Audio* audio)
{
	Audio* temp;
...
SoundManager::Audio* SoundManager::createAudio(const char* filename, uint8_t loop, int volume)
{
...
void SoundManager::playAudio(const char* filename, Audio* audio, uint8_t loop, int volume)
{
	Audio* newAudio;
...
void SoundManager::addAudio(Audio* root, Audio* newAudio)
{
	if (root == NULL)
	{
		return;
